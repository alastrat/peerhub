...
export function PricingFeaturesTableSection() {
  // Features table always shows annual pricing as reference
  const billingFrequency: "annually" = "annually";
                  ...
                  <tr>
                    ...
                    >
                      ...
                      <div style={{ fontSize: "13px", color: "#888", fontWeight: 400 }}>
                        Precio por mes (facturación anual)
                      </div>
                    </th>
                    {plans.map((plan) => (
                      <th
                      ...
                      >
                        <div style={{ fontWeight: 600, color: plan.isRecommended ? "#613171" : "#1a1a2e" }}>
                          {plan.name}
                        </div>
                        <div style={{ fontSize: "13px", color: "#888", fontWeight: 400 }}>
                          {isVariablePrice(plan.price)
